...
static void hundertNeunIDFkt(uint8_t *ptrID) {
    ...
    hundertNeunID[VERS_NR_PROT_0]  = *( ptrID + 4 );
    hundertNeunID[OUT_VOLT_1]  = *( ptrID + 4 );
    hundertNeunID[OUT_VOLT_2]  = *( ptrID + 4 );
    hundertNeunID[OUT_CUURR_3]  = *( ptrID + 4 );
    hundertNeunID[VERB_LADE_TIM_S_6]  = *( ptrID + 4 );
    hundertNeunID[VERB_LADE_TIM_S_7]  = *( ptrID + 4 );
    hundertNeunID[STAT_ST_5_0 / 10]  = *( ptrID + 4 ) & 0b00000001;
    hundertNeunID[FEHL_FKT_STAT_5_1 / 10]  = *( ptrID + 4 ) & 0b00000010;
    hundertNeunID[VERR_FRZG_KUPP_5_2 / 10]  = *( ptrID + 4 ) & 0b00000100;
    hundertNeunID[BATT_KOMPAT_5_3 / 10]  = *( ptrID + 4 ) & 0b00001000;
    hundertNeunID[FEHL_FKT_LADE_SYS_5_5 / 10]  = *( ptrID + 4 ) & 0b00100000;
    hundertNeunID[STEUER_LADE_AB_5_5 / 10]  = *( ptrID + 4 ) & 0b00100000;
}
