...
tTransition trans[] = {
                        ...
                        { ST_START_CHARGIN_OUTPUT, EV_TRAN_CHARGIN_STOP_RQ, 10, &stopCharging          },
                        ...
                        /*ERROR Zustände */
                        /*source -> vehicle*/
                        { ST_ANY, EV_ERR_BATT_VOLT_UP_LIM, 10, &errBattOverV },
                        { ST_ANY, EV_ERR_BATT_VOLT_DO_LIM, 10, &errBattUnderV },
                        { ST_ANY, EV_ERR_OUT_CURRE_DEVIAT, 10, &errBattDeviatI },
                        { ST_ANY, EV_ERR_BATT_TEMP_UP_LIM, 10, &errBattHighTemp },
                        { ST_ANY, EV_ERR__CHARG_VOLT_DIFF, 10, &errBattDiffV },
                        { ST_ANY, EV_ERR_CHARGER_TIME_OUT, 10, &error },
                        { ST_ANY, EV_ERR_CHARGER_TIME_OUT, 10, &error },
                        { ST_ANY, EV_ERR_VIH_ANY_OTH_FAUL, 10, &error },
                        { ST_ANY, EV_ERR_VEHIC_MOVABLE_ST, 10, &error },
                        { ST_ANY, EV_ERR_ANY_FAUL_IN_VEHI, 10, &error },

                        /*source -> charger*/
                        { ST_ANY, EV_ERR_ERROR_IN_CHARGER, 10, &error },
                        { ST_ANY, EV_ERR__CHARG_CONN_LOCK, 10, &error },
                        { ST_ANY, EV_ERR_MAIN_CIRCUIT_ERR, 10, &error },
                        { ST_ANY, EV_ERR_EMER_STP_BUTT_ON, 10, &error },
                        { ST_ANY, EV_ERR_REQU_VOLT_HIGHER, 10, &error },
                        { ST_ANY, EV_ERR_VEHICLE_TIME_OUT, 10, &error },
                        { ST_ANY, EV_ERR_VEHI_DATA_NO_REC, 10, &error },
                        { ST_ANY, EV_ERR_BATT_VOLT_NO_APP, 10, &error },
                        { ST_ANY, EV_ERR_CHARGE_VOLT_HIGH, 10, &error },
                        { ST_ANY, EV_ERR_BATT_VOL_AFT_TER, 10, &error },
                        { ST_ANY, EV_ERR_DC_HIGH_TRS_VOLT, 10, &error },
                        { ST_ANY, EV_ERR_CHR_ANY_OTH_FAUL, 10, &error },
                        { ST_ANY, EV_ERR_DISC_CAN_SEQ_SIG, 10, &error },
