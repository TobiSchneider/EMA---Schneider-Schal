...
/*Nachrichten-Felder*/
/*vehicle -> Fahrzeug*/
uint8_t hundertID[HUND_ID_MAX];//          = {0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000                 } ;
uint8_t hundertEinsID[HUND_EINS_ID_MAX];// = {0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000         } ;
uint8_t hundertZweiID[HUND_ZWEI_ID_MAX];// = {0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000         } ;

/*charger -> Säule*/
uint8_t hundertAchtID[HUND_ACHT_ID_MAX];// = {0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000                 } ;
uint8_t hundertNeunID[HUND_NEUN_ID_MAX];// = {0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000 } ;
...
uint8_t getVehicChargePerm( void ) ;   // switch (k). Rückgabewert: 0 -> Falls switch (k) is OFF ; 1 -> Falls switch (k) is ON
