...
#define EV_EXCEE_TARG_BATT_VOLT 5041    // If the charger receives “Target battery voltage” exceeding this value from the vehicle, regard this situation as “Battery incompatible” and shift to charge termination process.
#define EV_EXCEE_VEHI_CURR_REQU 5042    // If the charger receives “Charge current request” exceeding this value from the vehicle, regard this situation as “Charging system fault” and shift to charge termination process
#define EV_CHRG_VOLT_REACH_THRS 5043    // — When circuit voltage reaches to this value, the charger stops charging output.
